...
- (void)viewDidLoad
{
    ...
    if (self.type == CJPlaceTypeState) {
        ...
        UIBarButtonItem *backButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(dissmiss)];
...
//            place = [NSString stringWithFormat:@"%@ %@",_placeName,_places[indexPath.row][@"city"]];
            place = [NSString stringWithFormat:@"%@",_placeName];
            break;
...
//        [self.navigationController popViewControllerAnimated:YES];
   NSString *place = [NSString stringWithFormat:@"%@",_places[indexPath.row][@"state"]];
